...
const COPY = {
  ...
  vi: {
    ...
    book: "Đặt lịch trà",
    place: "Hà Giang · Việt Nam",
    hero: "Trà từ cây cổ thụ, làm cho thế giới bên ngoài núi.",
    heroBody: "Nhà làm Trà Hoàng Long làm trà Shan Tuyết cổ thụ Hà Giang bằng kỷ luật chế biến Nhật Bản. Gia đình làm trà từ năm 1995.",
    explore: "Xem trà mùa này",
    trade: "Dành cho quán & nhà hàng",
    season: "Những lá trà hiện có",
    seasonBody: "Mỗi vụ trà đều thay đổi. Danh mục đi theo lượng trà thực sự có, không giả vờ rằng kệ hàng luôn cố định.",
    viewTea: "Xem trà",
    noTea: "Danh mục trà mùa này đang được chuẩn bị.",
    origin: "Ngôi nhà phía sau búp trà",
    originBody: "Không phải chuyện nông trại được đánh bóng thành quảng cáo. Đây là một nhà làm trà đang hoạt động: quan hệ với vùng núi, chế biến cẩn trọng, và công việc lâu dài để trà Việt được hiểu ở bên ngoài.",
    readStory: "Đọc câu chuyện",
    twoWays: "Hai lối vào Nhà",
    retailTitle: "Trà cho bàn trà của bạn",
    retailBody: "Gói nhỏ, trà theo mùa, và một đường nối trực tiếp về người làm ra chúng.",
    wholesaleTitle: "Trà cho công việc của bạn",
    wholesaleBody: "Mẫu thử, công thức cho quán, quy cách số lượng lớn và trao đổi xuất khẩu cho đối tác nghiêm túc.",
    shopNow: "Vào cửa hàng",
    wholesaleNow: "Dành cho đối tác",
    closing: "Trà ngon không cần một câu chuyện ồn hơn. Chỉ cần một câu chuyện rõ hơn.",
