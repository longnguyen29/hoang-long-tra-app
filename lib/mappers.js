...
export function fromOrderRow(r) {
  return {
    ...
    publicTrackingToken: r.public_tracking_token,
...
export function toOrderRow(o) {
  return {
    ...
    public_tracking_token: o.publicTrackingToken,
...
export function fromPaymentRow(r) {
  if (!r)
    return withPaymentBankOverride({ bin: "", bankShortName: "", accountNumber: "", accountName: "" });
  return withPaymentBankOverride({
    bin: r.bin || "",
