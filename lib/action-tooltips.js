...
const VIEW_RULES = [
  {
    ...
    text: hint(
      ...
      "Chuyển Bảng điều khiển sang tiền mặt, doanh thu, ngân sách và các ngoại lệ cần chủ doanh nghiệp quyết định.",
    ),
  },
  {
    path: /^\/admin$/,
    ...
    text: hint(
      ...
      "Chuyển Bảng điều khiển sang các lượt theo đuổi đến hạn, báo giá, nhịp đặt lại và hội thoại chưa đọc.",
    ),
  },
  {
    path: /^\/admin$/,
    ...
    text: hint(
      ...
      "Chuyển Bảng điều khiển sang đơn đang mở, việc bị chặn, công nợ quá hạn và ngân sách còn dùng được.",
    ),
  },
  {
...
const ROUTE_HINTS = [
  {
    test: /^\/admin$/,
    text: hint(
      "Open Dashboard: today's priorities, exceptions, operating signals, and company memory.",
      "Mở Bảng điều khiển: ưu tiên hôm nay, ngoại lệ, tín hiệu vận hành và trí nhớ công ty.",
    ),
  },
  {
...
const RULES = [
  ...
  },
  {
    ...
    text: hint(
      ...
      "Ghim ngoại lệ này vào một vị trí ưu tiên còn trống trên Bảng điều khiển.",
    ),
  },
  {
  ...
  },
  {
    ...
    text: hint(
      ...
      "Lưu việc này vào vị trí ưu tiên đã chọn trên Bảng điều khiển.",
    ),
  },
  {
  ...
  {
    test: /^(create payment request|tạo yêu cầu thanh toán)$/iu,
    text: hint(
      "Create a private payment request for any priced order that does not already have one, including its due date and terms.",
      "Tạo yêu cầu thanh toán riêng cho đơn đã có tổng tiền và chưa có yêu cầu, gồm hạn và điều khoản thanh toán.",
    ),
  },
  {
    test: /^(create request|tạo yêu cầu)$/iu,
    text: hint(
      "Save this payment request against the selected order with its reference, due date, amount, and payment terms.",
      "Lưu yêu cầu thanh toán cho đơn đã chọn cùng mã tham chiếu, hạn, số tiền và điều khoản thanh toán.",
    ),
  },
  {
