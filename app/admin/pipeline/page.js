...
import TradePipeline from "@/components/staff/TradePipeline";
...
export default function TradePipelinePage() {
  ...
  if (status === "checking") return <main className="hl-admin-state" aria-live="polite"><span className="hl-admin-state__pulse"/><p>Đang mở bàn phát triển đối tác…</p></main>;
  ...
  return <TradePipeline supabase={supabase} email={email}/>;
}
